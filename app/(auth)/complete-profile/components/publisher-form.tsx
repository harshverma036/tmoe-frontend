...
} from "@/lib/types/publisher-profile"
...
const PublisherProfileForm = () => {
   ...
   */
  const {
    mutateAsync: submitPublisherProfile,
    isPending: isSubmittingProfile,
  } = useMutation({
                    ...
                    {regions.map((region) => {
                      ...
                      return (
                        <Button
                          ...
                          onClick={() =>
                            toggleMultiValue("regions_covered", region)
                          }
                        >
                          {region}
                        </Button>
                  ...
                  {contentCategories.map((category) => {
                    ...
                    return (
                      <Button
                        ...
                        variant={selected ? "default" : "outline"}
                        onClick={() =>
                          toggleMultiValue("content_categories", category)
                        }
                      >
                        {category}
                      </Button>
            ...
            {currentStep === 3 && (
              <div className="space-y-4">
                {fields.map((field, index) => (
                  ...
                  >
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                      ...
                      <div className="grid gap-2">
                        <Label htmlFor={`content_inventory.${index}.category`}>
                          Category
                        </Label>
                        <Input
                          ...
                          errorMessage={
                            errors.content_inventory?.[index]?.category?.message
                          }
                        />
                      </div>
                      <div className="grid gap-2">
                        <Label
                          htmlFor={`content_inventory.${index}.estimated_traffic`}
                        >
                          Estimated traffic
                        </Label>
                        <Input
                          ...
                          placeholder="25000"
                          {...register(
                            `content_inventory.${index}.estimated_traffic`,
                            {
                              valueAsNumber: true,
                            }
                          )}
                          errorMessage={
                            errors.content_inventory?.[index]?.estimated_traffic
                              ?.message
                          }
                        />
                      </div>
                ...
                {typeof errors.content_inventory?.message === "string" && (
                  <p className="text-sm text-red-500">
                    {errors.content_inventory.message}
                  </p>
                )}
                <Button
                  type="button"
